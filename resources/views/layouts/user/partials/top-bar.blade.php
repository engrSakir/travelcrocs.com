        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="menu-wrapper">
                    <div class="logo mr-5">
                        <a href="#"><img src="{{ asset('assets/frontend/images/logo2.png') }}" alt="logo"></a>
                                ...
                                <div class="dropdown">
                                    <a href="#" class="dropdown-toggle" id="userDropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm flex-shrink-0 mr-2"><img src="{{ asset('assets/frontend/images/team8.jpg') }}" alt="team-img"></div>
